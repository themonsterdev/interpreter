...
MultiplicationExpression::MultiplicationExpression(ExpressionInterface::Pointer expression, Token::Iterator& begin, Token::Iterator& end)
    : ::OperatorExpression(expression, begin, end)
{}

void MultiplicationExpression::DoInterpret(Context& context, long left, long right)
{
